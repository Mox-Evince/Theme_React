...
// ** Types
import { ProfileHeader as ProfileHeaderType } from './types'
...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ data }) => {
  ...
  return (
    <Card className='profile-header mb-2'>
      <CardImg src={data.coverImg} alt='Profile cover' top />
      <div className='position-relative'>
        <div className='profile-img-container d-flex align-items-center'>
          <div className='profile-img'>
            <img className='rounded img-fluid' src={data.avatar} alt='Profile avatar' />
          </div>
